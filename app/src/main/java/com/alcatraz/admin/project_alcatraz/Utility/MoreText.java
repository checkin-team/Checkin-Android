...
public class MoreText extends android.support.v7.widget.AppCompatTextView {
    ...
    public MoreText(Context context) {
        this(context, null);
    }

    public MoreText(Context context, AttributeSet attrs) {
        super(context, attrs);
...
public void setLong(String text){
    ...
    private CharSequence getTrimmedText(CharSequence text) {
        ...
        Log.e("Shivansh", "If I am HERE"+readMore +" ");
