...
public class ChatActivity extends AppCompatActivity{
    ...
    public void randomChat(){
        message=new ArrayList<>();time=new ArrayList<>();
        type=new ArrayList<>();
        ...
        RecyclerView recyclerView=findViewById(R.id.recycler_chat);
         chatAdapter = new ChatAdapter(message,time,type);
    ...
    public void sendmessage(View v)
    {
        ...
        ((RecyclerView)findViewById(R.id.recycler_chat)).scrollToPosition(message.size()-1);
        text.setText("");
