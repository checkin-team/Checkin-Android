...
public class ActiveSessionItemCustomizationFieldHolder {
    ...
    ActiveSessionItemCustomizationFieldHolder(@NonNull ItemCustomizationFieldModel customizationField, Context context, @NonNull CustomizationFieldInteraction interactionListener) {
    ...
    public interface CustomizationFieldInteraction {
        void onSelect(ActiveSessionItemCustomizationFieldHolder holder);

        void onDeselect(ActiveSessionItemCustomizationFieldHolder holder);
    }
}
