...
data class MessageModel(
    ...
    fun shouldTryUpdateUi(): Boolean = when (type) {
        ...
        MESSAGE_TYPE.MANAGER_SCHEDULED_CBYG_CUSTOMER_DELAYED,
        MESSAGE_TYPE.MANAGER_SCHEDULED_QSR_CUSTOMER_DELAYED
        -> false
        else -> true
    }
...
enum class MESSAGE_TYPE(var id: Int) {
    ...
    MANAGER_SCHEDULED_CBYG_CUSTOMER_DELAYED(662),
    MANAGER_SCHEDULED_QSR_NEW_PAID(672), MANAGER_SCHEDULED_QSR_CANCELLED(677),
    MANAGER_SCHEDULED_QSR_CUSTOMER_DELAYED(682),
