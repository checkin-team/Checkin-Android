...
public class ChatActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mUserId = getIntent().getStringExtra(Constants.EXTRA_SELECTED_USER_ID);
    ...
    {
        Message msg = new Message(edChatText.getText().toString(), new Date(), 0, Integer.valueOf(mUserId));
