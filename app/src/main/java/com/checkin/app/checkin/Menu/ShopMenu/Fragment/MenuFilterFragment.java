...
import com.checkin.app.checkin.Menu.ShopMenu.Adapter.FilterCategoryAdapter;
    ...
    public void filterByAvailableMeal(View v) {
        switch (v.getId()) {
            case R.id.btn_filter_breakfast:
                mViewModel.filterMenuGroups(MenuItemModel.AVAILABLE_MEAL.BREAKFAST);
                break;
            case R.id.btn_filter_lunch:
                mViewModel.filterMenuGroups(MenuItemModel.AVAILABLE_MEAL.LUNCH);
                break;
            case R.id.btn_filter_dinner:
                mViewModel.filterMenuGroups(MenuItemModel.AVAILABLE_MEAL.DINNER);
                break;
        }
        hideFilter();
    }
