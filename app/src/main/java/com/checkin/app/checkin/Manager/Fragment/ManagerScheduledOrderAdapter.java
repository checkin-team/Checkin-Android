...
public class ManagerScheduledOrderAdapter extends RecyclerView.Adapter<ManagerScheduledOrderAdapter.ViewHolder> {
    private List<SessionOrderedItemModel> mOrders;
    private SessionOrdersInteraction mListener;

    ManagerScheduledOrderAdapter(List<SessionOrderedItemModel> orders, SessionOrdersInteraction ordersInterface) {
        mOrders = orders;
