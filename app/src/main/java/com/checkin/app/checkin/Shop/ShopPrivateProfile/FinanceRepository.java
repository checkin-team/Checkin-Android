...
public class FinanceRepository {
    ...
    public LiveData<Resource<FinanceModel>> getRestaurantFinanceById(String restaurantId){
    ...
    public LiveData<Resource<GenericDetailModel>> setRestaurantFinanceById(FinanceModel financeModel,String restaurantId){
