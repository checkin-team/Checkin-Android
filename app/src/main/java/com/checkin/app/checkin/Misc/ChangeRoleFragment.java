...
public class ChangeRoleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        {rootView = inflater.inflate(R.layout.fragment_change_role_no_assigned, container, false);
            }
        else
        {            rootView = inflater.inflate(R.layout.fragment_change_role_assigned, container, false);
