            ...
            if (listResource.getStatus() == Resource.Status.SUCCESS && listResource.getData() != null) {
                ...
                AccountHeaderBuilder accountHeaderBuilder = new AccountHeaderBuilder()
                        ...
                        .withOnAccountHeaderListener((view, iProfile, b) -> {
                                    ...
                                    AccountModel account = accounts.get((int) profileDrawerItem.getIdentifier());
                                    if (account == null) return false;
                                    AccountModel currAccount = mViewModel.getCurrentAccount().getValue();
                                    if (!account.equals(currAccount)) {
                                        mViewModel.setCurrentAccount(account);
                                        switchAccount(getApplicationContext(), account);
                ...
                for (AccountModel account : accounts) {
                    //to check if id is a number or  not and making the parsing safe
...
//        Spinner vAccountSelector;
        ...
        public AccountHeaderViewHolder(BaseAccountsActivity baseAccountsActivity) {
