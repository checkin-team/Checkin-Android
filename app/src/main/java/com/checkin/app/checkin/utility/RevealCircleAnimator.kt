...
import com.checkin.app.checkin.utility.RevealCircleAnimatorHelper.Companion.addBundleValues
 ...
 * @author tfighiera
 * @sample https://raw.githubusercontent.com/ThibaultFighieraPJ/KRevealCircle/master/app/src/main/java/com/tfighiera/revealactivity/RevealCircleAnimatorHelper.kt
 * @version 1.0
 */
class RevealCircleAnimatorHelper {
    ...
    private fun getCircularAnimator(targetView: View, sourceX: Int, sourceY: Int, speed: Long): Animator {
        ...
        return AnimUtils.createCircularRevealAnimator(targetView, sourceX, sourceY, 0f, finalRadius).apply {
