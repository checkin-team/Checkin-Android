...
import com.checkin.app.checkin.Menu.ActiveSessionMenu.Adapter.ActiveSessionMenuCartAdapter;
import com.checkin.app.checkin.Menu.Adapter.MenuTreatYourselfAdapter;
...
public class MenuCartFragment extends BaseFragment implements ActiveSessionMenuCartAdapter.MenuCartInteraction, MenuTreatYourselfAdapter.TreatYourselfInteraction {
    ...
    private ActiveSessionMenuCartAdapter mCartAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mCartAdapter = new ActiveSessionMenuCartAdapter(this);
        ...
        mViewModel.getServerOrderedItems().observe(this, resource -> {
            ...
            if (resource.status == Resource.Status.SUCCESS) {
                ...
                ((ActiveSessionMenuActivity) getActivity()).finish();
