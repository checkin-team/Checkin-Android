...
public class ItemCustomizationGroup {
    private static final String TAG = ItemCustomizationGroup.class.getSimpleName();
    ...
    @Backlink (to = "group")
    @JsonIgnore private ToMany<ItemCustomizationField> customizationFields;
    ...
    public ToMany<ItemCustomizationField> getCustomizationFields() {
        return customizationFields;
    }

    @JsonProperty("fields")
    public void setCustomizationFields(List<ItemCustomizationField> customizationFields) {
