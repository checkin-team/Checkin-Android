...
public class UserShopProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_shop_profile);
    ...
    private class ShopViewPager extends FragmentPagerAdapter {
        ...
        public ShopViewPager(FragmentManager fm) {
            ...
            fragments.add(new UserShopProfileHomeFragment());
            fragments.add(new UserShopProfileHomeFragment());
            fragments.add(new UserShopProfileHomeFragment());
        }
