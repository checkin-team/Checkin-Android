...
public class ShopModel {
    ...
    public ShopModel(long id, String name, String bio, boolean active, boolean onlyVegetarian, String address, String city, String phone, String email, String website, boolean verified, float rating) {
        this.id = id;
        this.name = name;
        this.bio = bio;
        this.active = active;
