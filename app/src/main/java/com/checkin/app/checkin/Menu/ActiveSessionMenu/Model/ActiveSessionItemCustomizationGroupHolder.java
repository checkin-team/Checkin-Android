package com.checkin.app.checkin.Menu.ActiveSessionMenu.Model;
...
public class ActiveSessionItemCustomizationGroupHolder implements ActiveSessionItemCustomizationFieldHolder.CustomizationFieldInteraction {
    ...
    private List<ActiveSessionItemCustomizationFieldHolder> selectedFields = new ArrayList<>();
    private CustomizationGroupInteraction mInteractionListener;

    public ActiveSessionItemCustomizationGroupHolder(@NonNull ItemCustomizationGroupModel customizationGroup, Context context, CustomizationGroupInteraction interactionListener) {
        mGroup = customizationGroup;
        mView = ((ViewGroup) LayoutInflater.from(context).inflate(R.layout.item_as_menu_customization_group, null, false));
        ...
        for (ItemCustomizationFieldModel field : mGroup.getCustomizationFields()) {
            vListFields.addView(new ActiveSessionItemCustomizationFieldHolder(field, context, this).getView());
        }
    }

    @Override
    public void onSelect(ActiveSessionItemCustomizationFieldHolder holder) {
    ...
    @Override
    public void onDeselect(ActiveSessionItemCustomizationFieldHolder holder) {
