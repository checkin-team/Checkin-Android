...
abstract class ManagerStatsModelPoorOrderHolder : EpoxyModelWithHolder<ManagerStatsModelPoorOrderHolder.Holder>() {
    @EpoxyAttribute
    internal lateinit var data: ManagerStatsModel.PoorOrders
    override fun bind(holder: Holder) = holder.bindData(data)

    class Holder : BaseEpoxyHolder<ManagerStatsModel.PoorOrders>() {
        ...
        override fun bindData(data: ManagerStatsModel.PoorOrders) {
