...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        isArrowHidden = typedArray.getBoolean(R.styleable.NiceSpinner_ns_hideArrow, false);
        arrowDrawableTint = typedArray.getColor(R.styleable.NiceSpinner_ns_arrowTint, Integer.MAX_VALUE);
        arrowDrawableResId = typedArray.getResourceId(R.styleable.NiceSpinner_ns_arrowDrawable, R.drawable.arrow);
        dropDownListPaddingBottom =
                typedArray.getDimensionPixelSize(R.styleable.NiceSpinner_ns_dropDownListPaddingBottom, 0);
        typedArray.recycle();
