 ...
 */
public class NiceSpinnerArrowOnly extends AppCompatImageButton {
    ...
    public NiceSpinnerArrowOnly(Context context) {
        super(context);
        init(context, null);
    }

    public NiceSpinnerArrowOnly(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public NiceSpinnerArrowOnly(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.NiceSpinnerArrowOnly);
        ...
        backgroundSelector = typedArray.getResourceId(R.styleable.NiceSpinnerArrowOnly_backgroundSelector, R.drawable.selector);
        setBackgroundResource(backgroundSelector);
        textColor = typedArray.getColor(R.styleable.NiceSpinnerArrowOnly_textTint, getDefaultTextColor(context));
        ...
        isArrowHidden = typedArray.getBoolean(R.styleable.NiceSpinnerArrowOnly_hideArrow, false);
        arrowDrawableTint = typedArray.getColor(R.styleable.NiceSpinnerArrowOnly_arrowTint, Integer.MAX_VALUE);
        arrowDrawableResId = typedArray.getResourceId(R.styleable.NiceSpinnerArrowOnly_arrowDrawable, R.drawable.arrow);
        popupWidth = typedArray.getDimensionPixelSize(R.styleable.NiceSpinnerArrowOnly_popupWidth, getMeasuredWidth());
        dropDownListPaddingBottom =
                typedArray.getDimensionPixelSize(R.styleable.NiceSpinnerArrowOnly_dropDownListPaddingBottom, 0);
        typedArray.recycle();
    ...
    public void showDropDown() {
        ...
        popupWindow.showAsDropDown(this, -popupWidth + getMeasuredWidth(), 0);
    }

    private void measurePopUpDimension() {
        int widthSpec = MeasureSpec.makeMeasureSpec(popupWidth, MeasureSpec.EXACTLY);
