...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
        ...
        public void onClick(View v) {
            if (v == mBackBtn) {
                if (mLastSearchTerm.length() == 0 ||
                    ...
                    mSearchSrcTextView.setText(mLastSearchTerm);
    ...
    private void clearSearch() {
        ...
        if (mOnQueryChangeListener != null) {
            mOnQueryChangeListener.onQueryClear();
        }
    }
    ...
    private void onVoiceClicked() {
        ...
        if (mContext instanceof Activity) {
            ...
            scanForActivity(mContext).startActivityForResult(intent, REQUEST_VOICE);
        }
    }
    ...
    public void setStartFromRight(boolean bool) {
        mStartFromRight = bool;
    }
    ...
    private void setVisibleWithAnimation() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            AnimationUtil.reveal(mSearchTopBar, animationListener, mStartFromRight);
    ...
    public void closeSearch() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mSearchLayout.setVisibility(View.VISIBLE);
            AnimationUtil.hide(mSearchTopBar, animationListener, mStartFromRight);
